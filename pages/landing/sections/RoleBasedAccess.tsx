...
const ROLES = [
  ...
  },
  {
    ...
    desc: 'Finance Managers validate payouts and settlements. Marketing Managers track asset deployments, cooler requests, and compliance.',
    icon: '💼',
    features: ['Payout Validation', 'Asset Tracking', 'Compliance Audits'],
    accentColor: '#059669',
  },
  {
    title: 'Retailers (Clients)',
    desc: 'Submit system-generated bills, track QPS slabs and projected payouts, and upload compliance photos within the 15-day window.',
    icon: '🏪',
    features: ['Invoice Uploads', 'QPS Tracking', 'Compliance Verification'],
    accentColor: '#D97706',
  },
];
